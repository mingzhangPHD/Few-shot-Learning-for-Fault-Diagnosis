...
class FeatureExtractor_2(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.conv1 = nn.Conv1d(in_channels=self.args.in_channels, out_channels=16, kernel_size=64, stride=16, padding=0)
        self.relu1 = nn.ReLU()
...
class FeatureExtractor_4(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.fc1 = nn.Linear(in_features=64*self.args.conv_final_size, out_features=self.args.backbone_out_dim)
