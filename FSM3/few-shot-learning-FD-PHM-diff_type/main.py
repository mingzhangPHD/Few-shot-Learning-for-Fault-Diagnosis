...
if __name__ == "__main__":
    ...
    #                                   'CaseDE12K_class10_2048_' + args.exp_dataset + '_target.h5')
    #     assert args.data_size == 2048
    if args.transfer_type == '1to2':
        train_data_path = os.path.join(args.base_data_path, 'PHM2009_dataset_{}_helical_C3_1_2ST_out_g1.h5'.format(args.dataset))
        test_data_path = os.path.join(args.base_data_path, 'PHM2009_dataset_{}_helical_C3_1_2ST_out_g2.h5'.format(args.dataset))
    elif args.transfer_type == '2to1':
        train_data_path = os.path.join(args.base_data_path, 'PHM2009_dataset_{}_helical_C3_1_2ST_out_g2.h5'.format(args.dataset))
        test_data_path = os.path.join(args.base_data_path, 'PHM2009_dataset_{}_helical_C3_1_2ST_out_g1.h5'.format(args.dataset))
    else:
        raise ValueError()
