...
def parse_args():
    ...
    parser.add_argument('--random_seed', default=100, type=int, help='random seed in experiments, default is 10')
    parser.add_argument('--base_data_path', default='/data_disk/dataset/FD/PHM2009_C3_K2_diff_type/', help='base path keeping image data')

    parser.add_argument('--dataset', default='30Hz_L', help='30-50Hz_H/L')
    parser.add_argument('--transfer_type', default='2to1', help='1to2 or 2to1')
    ...
    parser.add_argument('--base_logdir', default='/data_disk/deeplearning/few-shot-learning-FD-PHM-diff_fault/exp_logs/', help='folder to keep all running files')
    ...
    parser.add_argument('--save_feat', default=True, type=str, help='whether to save feature')

    # few-shot task setting
    parser.add_argument('--train_n_way', default=2, type=int, help='class num to classify for training')
    parser.add_argument('--test_n_way', default=2, type=int, help='class num to classify for testing (validation) ')
    ...
    parser.add_argument('--pretrain_source_num_classes', default=2, type=int, help='total number of classes')
    parser.add_argument('--pretrain_target_num_classes', default=2, type=int, help='total number of classes')
